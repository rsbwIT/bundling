...
// They typically contain an <a href="#" class="nav-link">.
// Since the file is well-structured by indentation, let's use a line-by-line approach.

$lines = explode("\n", $content);
$out = [];
$in_parent_li = false;
$parent_li_start_idx = -1;
$parent_urls = [];
$parent_li_depth = 0;
$buffer = [];
...
file_put_contents('c:/xampp/htdocs/bundling2/scratch_wrap_parents_2.blade.php', implode("\n", $out));
echo "Done writing scratch_wrap_parents_2.blade.php\n";
