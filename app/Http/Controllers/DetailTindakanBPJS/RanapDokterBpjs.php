...
class RanapDokterBpjs extends Controller
{
    ...
    function RanapDokterBpjs(Request $request)
    {
        $actionCari = '/ranap-dokter-bpjs';
        ...
        $RalanDokter = DB::table('pasien')
            ->select('rawat_jl_dr.no_rawat',
                ...
                'rawat_jl_dr.bhp',
                DB::raw("CASE WHEN rawat_jl_dr.kd_jenis_prw IN ('RJBP0053', 'RJBP0056') THEN jns_perawatan.tarif_tindakandr ELSE rawat_jl_dr.tarif_tindakandr END as tarif_tindakandr"),
                'rawat_jl_dr.kso',
