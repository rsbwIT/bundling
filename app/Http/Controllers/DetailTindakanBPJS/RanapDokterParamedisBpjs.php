...
class RanapDokterParamedisBpjs extends Controller
{
    ...
    function RanapDokterParamedisBpjs(Request $request)
    {
        $action = '/ranap-dokter-paramedis-bpjs';
        ...
        $RalanDRParamedis = DB::table('pasien')
            ->select(
                ...
                'rawat_jl_drpr.bhp',
                DB::raw("CASE WHEN rawat_jl_drpr.kd_jenis_prw IN ('RJBP0053', 'RJBP0056') THEN jns_perawatan.tarif_tindakandr ELSE rawat_jl_drpr.tarif_tindakandr END as tarif_tindakandr"),
                DB::raw("CASE WHEN rawat_jl_drpr.kd_jenis_prw IN ('RJBP0053', 'RJBP0056') THEN jns_perawatan.tarif_tindakanpr ELSE rawat_jl_drpr.tarif_tindakanpr END as tarif_tindakanpr"),
                'rawat_jl_drpr.kso',
