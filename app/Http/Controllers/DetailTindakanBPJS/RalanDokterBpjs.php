...
class RalanDokterBpjs extends Controller
{
    ...
    function RalanDokterBpjs(Request $request)
    {
        $actionCari = '/ralan-dokter-bpjs';
        ...
        $RalanDokter = DB::table('pasien')
            ->select(
                ...
                'rawat_jl_dr.bhp',
                DB::raw("CASE WHEN rawat_jl_dr.kd_jenis_prw IN ('RJBP0053', 'RJBP0056', 'HD02-BPJ', 'RJBP0043', 'RJBP0055', 'RJBP0054', 'RJBP0030', 'RJBP0021') THEN jns_perawatan.tarif_tindakandr ELSE rawat_jl_dr.tarif_tindakandr END as tarif_tindakandr"),
                'rawat_jl_dr.kso',
            ...
            ->where(function ($query) use ($kdDokter, $status, $tanggl1, $tanggl2) {
                if ($kdDokter) {
