...
class RalanDokterParamedis2 extends Controller
{
    ...
    function RalanDokterParamedis2(Request $request)
    {
        $action2 = '/ralan-dokter-paramedis2';
        ...
        return view('detail-tindakan.ralan-dokter-paramedis2', [
            ...
            'petugas' => $petugas,
            'dokter' => $dokter,
            'RalanDRParamedis2' => $RalanDRParamedis2,
        ]);
    }
}
