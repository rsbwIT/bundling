...
class RanapParamedis2 extends Controller
{
    ...
    function RanapParamedis2(Request $request)
    {
        $action2 = '/ranap-paramedis2';
        ...
        $RalanParamedis2 = DB::table('pasien')
            ...
            ->orderByDesc('rawat_jl_pr.no_rawat')
            ->get();

        return view('detail-tindakan-bulanan.ranap-paramedis2', [
            'action' => $action2,
            'penjab' => $penjab,
            'petugas' => $petugas,
            'getRanapParamedis2' => $getRanapParamedis2,
