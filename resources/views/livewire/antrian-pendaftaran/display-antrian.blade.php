                    ...
                    <div class="col-md-{{ $md }}">
                        <div class="card border-0 shadow-lg rounded-4 overflow-hidden h-100 animate__animated animate__fadeInUp"
                            ...
                            <div class="card-header text-center text-white py-3"
                                ...
                                <h2 class="fw-bold mb-0">{{ $loket->nama_loket }}</h2>
                            </div>
                            ...
                            <table class="table table-borderless mb-0">
                                ...
                                @else
                                    @foreach ($loket->getPasien as $pasien)
                                        <thead>
                                            <tr>
                                            ...
                                            <tr>
                                                <th colspan="3" class="text-center">
                                                    <span class="fw-bolder text-dark"
                                                          style="font-size: 5rem; letter-spacing: 2px;
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td colspan="3" class="text-center py-2">
                                                    <span class="badge bg-gradient px-4 py-2 fs-5 shadow-sm dokter-badge">
...
{{-- Tambahkan CSS di bawah ini (misalnya di section @push('styles')) --}}
<style>
.dokter-badge {
    background: linear-gradient(135deg, #17a2b8, #20c997);
    font-size:1.2rem;
    display: inline-block;
    max-width: 90%;          /* biar fleksibel di dalam card */
