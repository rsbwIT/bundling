...
<head>
    ...
    <style>
        ...
        /* ============================
           PRINT FIX – A4 FULL PAGE
        ============================ */
        @page {
            size: A4 portrait;   /* Ukuran kertas A4 */
            margin: 15mm;        /* Margin rapi */
        }

        @media print {
            body {
                zoom: 100% !important; /* Jangan mengecil */
...
{{-- KOP SURAT --}}
<div class="kop" style="width:100%; display:flex; align-items:center; border-bottom:2px solid #000; padding-bottom:10px; margin-bottom:20px;">
