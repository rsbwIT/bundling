...
<head>
    ...
    <link rel="icon" href="/img/rs.png" type="image/png">
    <link rel="stylesheet"
    ...
    <style>
        ...
        @keyframes fly {
            ...
            50%  { transform: translate(260px,0) rotate(-10deg); }
