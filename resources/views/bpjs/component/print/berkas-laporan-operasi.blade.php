    ...
    @foreach ($getLaporanOprasi as $item)
        <div class="">
            ...
            <table width="700px" class="mt-1">
                <tr style="vertical-align: top;">
                    <td width="140px">Tanggal</td>
                    <td width="250px">: {{ optional($item->pemeriksaanRanap)->tgl_perawatan ?? '-' }}</td>
                    <td width="140px">Waktu</td>
                    <td width="180px">: {{ optional($item->pemeriksaanRanap)->jam_rawat ?? '-' }}</td>
                </tr>
                <tr style="vertical-align: top;">
                    <td>Dokter Bedah</td>
                    <td>: {{ $item->operator1 ?? '-' }}</td>
                    <td>Alergi</td>
                    <td>: {{ optional($item->pemeriksaanRanap)->alergi ?? '-' }}</td>
                </tr>
            </table>
                ...
                <tr style="vertical-align: top;">
                    <td width="400px" style="border-right: 1px solid black">
                        ...
                        <table width="400px">
                            ...
                            <tr>
                                <td width="130px">- Suhu Tubuh (C)</td>
                                <td>: <i>{{ optional($item->pemeriksaanRanap)->suhu_tubuh ?? '-' }}</i></td>
                                <td width="130px">- Nadi (/Mnt)</td>
