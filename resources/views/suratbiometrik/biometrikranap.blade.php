...
@section('title', 'Surat Biometrik Ranap')

@push('styles')
<style>
    .card-header {
        background: linear-gradient(135deg, #0062cc, #0056b3); /* sama dengan Rajal */
        color: #fff;
        border-bottom: none;
        padding: 15px 20px;
    ...
    .table tbody tr:hover {
        background-color: rgba(0, 123, 255, 0.05); /* sama dengan Rajal */
    }
    .btn-action {
        margin: 2px;
        border-radius: 20px;
...
<div class="card shadow-sm">
    <div class="card-header">
        <h5 class="mb-0"><i class="fa fa-procedures"></i> Daftar Pasien Biometrik Ranap</h5>
    </div>
    <div class="card-body">
        {{-- 🔍 Form filter --}}
        <div class="filter-section">
            <form action="{{ route('biometrik.ranap.cari') }}" method="GET">
                <div class="row g-2">
                    <div class="col-md-3">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group" role="group">
                                {{-- Tombol Print --}}
                                <a href="{{ route('biometrik.ranap.print', ['id' => $pasien->id, 'tgl_awal' => $tgl_awal, 'tgl_akhir' => $tgl_akhir]) }}"
                                target="_blank"
                                ...
                                {{-- Tombol Formulir --}}
                                <a href="{{ route('formulir.biometrik.ranap.create', ['no_peserta' => $pasien->no_kartu_bpjs, 'no_rawat' => $pasien->id]) }}"
                                target="_blank"
