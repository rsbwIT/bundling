...
@section('title', 'Input SEP Biometrik Ranap')
        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm border-0 rounded-3">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-hospital-alt me-2"></i> Input SEP Biometrik Ranap</h5>
                </div>
                <div class="card-body">
                    ...
                    {{-- ✅ Form input SEP --}}
                    <form action="{{ route('biometrik.ranap.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
