                        ...
                        <tr>
                            ...
                            <td class="text-left">
                                @if($item->kode_id_khanza)
                                    <a href="{{ url('/jm-bpjs/detail') }}?kd_dokter={{ $item->kode_id_khanza }}&tgl1={{ $tanggl1 }}&tgl2={{ $tanggl2 }}&kdPenjamin={{ request('kdPenjamin') }}" target="_blank" title="Lihat detail tindakan">
